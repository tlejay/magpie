# CLAUDE.md — Magpie (โฟลเดอร์ 125 ZOOM)
...
> ชื่อโฟลเดอร์ยังเป็น `125 ZOOM` ตามเลขลำดับใน workspace แต่โปรเจคไม่ผูกกับ Zoom แล้ว
> repo ชื่อ `magpie` ถ้าจะเปลี่ยนชื่อโฟลเดอร์ต้องแก้ `WORKSPACE-INDEX.md` ที่ root ด้วย
